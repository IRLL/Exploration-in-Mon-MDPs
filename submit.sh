...
tar -xzf de2_venv.tar.gz -C "$SLURM_TMPDIR"/Exploration-in-Mon-MDPs/
...
# seff $JOB_ID # to check the efficiency of the run. SHOULD NOT be used in the submit script here. Its being mentioned here's
# just a reminder.
